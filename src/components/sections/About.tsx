...
export const About = (): JSX.Element => {
  return (
    <Section
      id="about"
      className="px-4 pb-12 pt-4 flex items-center justify-center flex-col gap-4 w-full md:px-8 lg:px-8"
    >
      <div className="grid gap-4 w-full h-auto flex-col lg:grid-cols-3 grid-cols-4">
        <motion.div
        ...
        >
          <div className="flex flex-col bg-content p-4 w-full rounded-3xl items-center justify-center border border-border">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
          viewport={{ once: true }}
          className="order-1 lg:order-2 lg:col-span-1 col-span-2 md:col-span-1"
        >
          <img
            src={pfp}
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
          viewport={{ once: true }}
          className="flex flex-col lg:order-3 lg:col-span-2 order-3 bg-content p-4 rounded-3xl gap-2 lg:gap-4 drop-shadow-2xl shadow-2xl col-span-full border border-border"
        >
          <h2 className="font-header text-neutral-100 text-3xl lg:text-4xl">
            About
          </h2>

          <p className="text-left font-paragraph text-base lg:text-2xl text-neutral-300">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
          viewport={{ once: true }}
          className="bg-content order-4 col-span-full p-4 rounded-3xl flex flex-col gap-2 lg:gap-4 drop-shadow-2xl shadow-2xl border border-border"
        >
          <h2 className="font-header text-neutral-100 text-3xl lg:text-4xl">
            Background
          </h2>
