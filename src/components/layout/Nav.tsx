...
export const Nav = (): JSX.Element => {
  return (
    <motion.nav
      ...
      className="flex flex-row gap-4 fixed z-50 bottom-0 w-full lg:flex-col lg:h-dvh lg:left-0 lg:justify-center lg:ml-2 lg:w-fit shadow-[0_-10px_20px_-1px_rgba(0,0,0,0.5)] lg:shadow-none"
    >
